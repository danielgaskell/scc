...
extern uint32_t _minuseqf(uint32_t, uint32_t*);
extern uint32_t _pluseqf(uint32_t, uint32_t*);
extern uint32_t _muleqf(uint32_t, uint32_t*);
extern uint32_t _diveqf(uint32_t, uint32_t*);
...
extern float _castf_f(uint32_t);
