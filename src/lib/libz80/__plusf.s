...
; add CHL.B to DEIX.0
  ...
  inc d
  inc d
  jp z,f32add_ret_inf2
  dec d
  rra
  rr h
  rr l
  .db #0x01 ; start of `ld bc,**`, eats the next two bytes of code
f32add_add_round:
  rl b
  jr f32add_output
...
;  inf +  inf    ==> inf
  ...
  or d
  or e
  jr nz, f32add_ret_BCDE  ;return NaN
